...
Система поддерживает шесть основных категорий усилений:

| Эффект | Описание |
|--------|----------|
| **Урон** | Увеличивает наносимый урон |
| **Броня** | Повышает защиту от входящего урона |
| **Скорость** | Ускоряет перемещение персонажа |
...
*Эффект Спешка не работает в режиме ПВП*
...
| **Этернити** | Урон 2, Броня 2, Скорость 2 | — |
| **Стингера** | Урон 2, Броня 2, Скорость 1 | — |
...
## Способы получения
- **Ивенты сервера**
- **Шалкеры, открываемые универсальным ключом**
- **Кейсы со сферами**
- **Магазин (`/shop`)**
...
При переплавке сфер в печке игроки получают осколки, количество которых зависит от редкости и эффектов уничтоженного предмета. Осколки используются для торговли с NPC "Сферомантом".
...
Уникальные сферы (Цербера, Флеша, Армоталити, Имморталити, Инфинити, Сатиры, Мифические сферы) не могут быть преобразованы в талисманы и остаются в своем первоначальном виде.
